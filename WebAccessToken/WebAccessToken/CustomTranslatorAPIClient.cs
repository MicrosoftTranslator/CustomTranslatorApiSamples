...
namespace TextTranslatorSampleCode
{
    public class CustomTranslatorAPIClient
    {
        ...
        /// </summary>
        /// <param name="authtoken">Access token.</param>
        public async Task<string> CreateProject(string authtoken)
        {
            ...
            TextTranslatorProjectCreateRequest newproject = new TextTranslatorProjectCreateRequest();
        ...
        public async Task<string> EditProject(string id, string authtoken)
        {
            ...
            TextTranslatorProjectEditRequest newproject = new TextTranslatorProjectEditRequest();
            newproject.name = "..."; // Enter Project Name
            newproject.categoryDescriptor = "..."; // Enter Project Category Descriptor
            newproject.description = "..."; // Enter Project Decription
        ...
        /// </summary>
        /// <param name="authtoken">Access token.</param>
        public async Task<string> ImportDocument(string authtoken)
        {
            string result = "";
            ...
            TextTranslatorDocumentDetailsForImportRequest documentdetails = new TextTranslatorDocumentDetailsForImportRequest();

            documentdetails.DocumentName = "..."; // Enter document name
            documentdetails.DocumentType = "..."; //values = training, tuning, testing
            documentdetails.IsParallel = true; // Enter if this is a parallel document. values = true, false
            documentdetails.FileDetails = new List<TextTranslatorFileForImportRequest>();

            TextTranslatorFileForImportRequest sourcelanguagefile = new TextTranslatorFileForImportRequest();
            ...
            TextTranslatorFileForImportRequest targetlanguagefile = new TextTranslatorFileForImportRequest();
            ...
            var details = new List<TextTranslatorDocumentDetailsForImportRequest>() { documentdetails };
        ...
        /// </summary>
        /// <param name="authtoken">Access token.</param>
        public async Task<string> ImportComboDocument(string authtoken)
        {
            string result = "";
            string apipath = $"/api/texttranslator/v1/documents/import";
            string filepath = @"..."; // Enter local path for combo file. Example .zip files
            ...
            TextTranslatorFileForImportRequest combofile = new TextTranslatorFileForImportRequest();
        ...
        /// </summary>
        /// <param name="authtoken">Access token.</param>
        public async Task<string> CreateModel(string authtoken)
        {
            ...
            TextTranslatorModelCreateRequest model = new TextTranslatorModelCreateRequest(); // Create new object for Model and add values
        ...
        public async Task<string> EditModel(long id, string authtoken)
        {
            ...
            TextTranslatorModelEditRequest model = new TextTranslatorModelEditRequest();
            model.name = "..."; // Enter model name
